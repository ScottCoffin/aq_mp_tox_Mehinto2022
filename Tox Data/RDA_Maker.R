...
R.ave <- R.ave.water.marine #just used marine value for Mehinto et al. (2022)

# mouth size estimations from body length (Jams et al. (2020))
...
volumefnx = function(R, L){
  volume = 0.111667 * pi * R^2 * L^3 #assumes height = 0.67 * Width, and Width:Length ratio is 'R' (R.ave average in marine surface water)
  return(volume)}
